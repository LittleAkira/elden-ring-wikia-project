...
Ea:["ytp-miniplayer-close-button","ytp-button"],W:{"aria-label":"Chiudi"},U:[g.eH()]});g.H(this,a);a.Ba(this.lC.element);this.T(a.element,"click",this.Fj);a=new g.V({G:"button",Ea:["ytp-miniplayer-replay-button","ytp-button"],W:{"aria-label":"Chiudi"},U:[g.kH()]});g.H(this,a);a.Ba(this.lC.element);this.T(a.element,"click",this.sZ);this.T(this.player,"presentingplayerstatechange",this.Sc);this.T(this.player,"appresize",this.xb);this.T(this.player,"fullscreentoggled",this.xb);this.xb()};
